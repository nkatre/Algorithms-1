...
extern void IError(char* fmt, ...);
extern void Error(char* fmt, ...);
extern void GError(char* fmt, ...);
extern int GErrors();
extern void GErrorRecover();
extern void Warning(char* fmt, ...);
extern void set_errors_tool_name(char* tn);
extern void set_verbose_mode();
extern void set_pipe_mode();
extern void set_verbose_mode(int i);
extern int Verbose(char* fmt, ...);
extern int Verbose(int i, char* fmt, ...);
extern int Verbose();
extern int AskYesNo(char* fmt, ...);
