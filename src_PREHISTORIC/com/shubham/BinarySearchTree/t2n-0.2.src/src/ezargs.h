...
public:
	...
	bool add_bool(char* key, char* man, bool* r);
	bool add_int(char* key, char* par, char* man, int* r, int dflt);
	bool add_int(char* key, char* par, char* man, int* r, bool* rset);
	bool add_string(char* key, char* par, char* man, char** r, char* dflt);
	bool add_extra(char* par, char* man, char** r, char* dflt);
